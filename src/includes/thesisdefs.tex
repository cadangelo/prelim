...
\gdef\@department{(Nuclear Engineering and Engineering Physics)} % Default is Electical Engineering
\gdef\@defensedate{09/01/2017}% Default is a long time from now.
\gdef\@committee{
  Paul P. H. Wilson, Professor, Nuclear Engineering\\
  Douglass Henderson, Professor, Nuclear Engineering\\
  Bryan Bednarz, Professor, Medical Physics\\
  Andrew Davis, Associate Scientist, Engineering Physics\\
  }
