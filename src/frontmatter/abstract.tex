...
The basis of MS-CADIS is that the importance %(adjoint) 
function used
...
%When MS-CADIS is applied to SDR analysis,
...
For systems that undergo movement,
%such as SDR calculations during maintenance activities,
 a new hybrid 
...
%The MC radiation transport code will be modified 
to implement rigid-body transformations on the CAD-based geometry.
%and GT-CADIS will be adapted to incorporate dynamics.  
%An experiment will be contrived to demonstrate the
