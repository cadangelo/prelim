...
\begin{frame}{Goal}
	...
	at a particular location when activated components are
...
\column{0.7\textwidth}
\begin{itemize}
	\item{Monte Carlo (MC) solution method \cite{mcnp_manual}}%analysis of FES is:}
	\begin{itemize}
...
\begin{frame}{TGT-CADIS: Generate Step-wise Geometries}
\begin{columns}
\column{0.45\textwidth}
	\vspace{-6cm}
	\begin{itemize}
...
\column{0.45\textwidth}
	...
	\end{itemize}
\vspace{1cm}
	\includegraphics[scale=0.25]{mesh_total.jpg}
...
%%%% 4. Adjoint Neutron Transport/Calc VR
\begin{frame}{TGT-CADIS: Generate VR Parameters}
\begin{columns}
\column{0.45\textwidth}
	\begin{itemize}
	...
	\begin{itemize}
		\item{Tools to update position of geometry based on
			...
			\begin{enumerate}
				...
				\item{DAGMC update to facilitate
